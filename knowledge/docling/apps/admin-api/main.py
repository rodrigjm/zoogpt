...
from routers import analytics_router, kb_router, config_router, images_router, feedback_router, pipeline_router
...
app.include_router(feedback_router, prefix="/api/admin")
